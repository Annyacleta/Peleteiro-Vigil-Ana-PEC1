...
Los datos seleccionados para esta PEC provienen del análisis por LC-MS de muestras fecales de ratones con cáncer colorectal que recibieron la microbiota de ratones sometidos a una dieta cetogénica o a una dieta estándar. Comparé el metaboloma fecal de los dos grupos de ratones con trasplante de microbiota para detectar diferencias en su composición, como señalan los autores del estudio. Encontré que....

HABLAR DEL PROCESO Y PRINCIPALES RESULTADOS
...
3. Búsqueda de un perfil de metabolitos fecales diferencial entre ratones MSD y ratones MCG -> el objetivo final del estudio es ver si esto condiciona el desarrollo tumoral en el intensitno grueso distal- 

...
- **Paquetes**: RMarkdown 2.29, BiocManager 1.30.25, SummarizedExperiment 1.34.0, tidyverse 2.0.0, tibble 3.2.1, ggplot2 3.5.1, patchwork 1.3.0, factoextra 1.0.7, FactoMineR 2.11, ggdendro 0.2.0
...
Por último, pruebo a realizar una agrupación de los metabolitos por el método de las k-means. 
...
solo con el PCA:
No se puede afirmar significancia estadística de la separación entre grupos.
No se identifican qué metabolitos son responsables de la separación (eso requiere un biplot o análisis diferencial).
No se establece causalidad ni dirección del cambio biológico

Más interesane ver microbiota o ampliar perfil metabolómico
